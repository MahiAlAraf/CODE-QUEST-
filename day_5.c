...
int Pointer_peak()
{
    ...
    correct_answer(Q1, Q1_option, 2, 10, 15, 3, Q1_explanation);
    if (HP <= 0) return HP;
    ...
    correct_answer(Q2, Q2_option, 2, 15, 15, 4, Q2_explanation);
    if (HP <= 0) return HP;
    ...
    correct_answer(Q3, Q3_option, 4, 15, 16, 5, Q3_explanation);
    if (HP <= 0) return HP;
    ...
    correct_answer(Q4, Q4_option, 3, 15, 17, 8, Q4_explanation);
    if (HP <= 0) return HP;
